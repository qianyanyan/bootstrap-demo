...
var tree_data = {
	'for-sale' : {name: '平台基础设施', type: 'folder'}	,
	'tickets' : {name: '课件库管理', type: 'item'}	,
	'services' : {name: '产品管理', type: 'item'}
}
tree_data['for-sale']['additionalParameters'] = {
	'children' : {
		'appliances' : {name: '人员与权限', type: 'item'},
		'arts-crafts' : {name: '地区设置', type: 'item'},
		'clothing' : {name: '项目管理', type: 'item'},
		'computers' : {name: '平台操作日记', type: 'item'},
		'jewelry' : {name: '课件库管理', type: 'item'},
		'office-business' : {name: '产品管理', type: 'item'}
	}
}
